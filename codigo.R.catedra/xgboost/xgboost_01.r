...
abril_dataset_sinclase <-   abril_dataset[ , !(names(abril_dataset) %in% c("clase") ) ] 
...
dtrain_sinpeso = xgb.DMatrix(data = data.matrix(abril_dataset_sinclase),label = abril_dataset$clase,missing = NA )
