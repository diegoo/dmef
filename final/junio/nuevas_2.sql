TRUNCATE extra_junio_2;

INSERT INTO extra_junio_2
(numero_de_cliente,
...
IF(SUM(Master_Finiciomora) = 0, 0, DATEDIFF(DATE(STR_TO_DATE('201606','%Y%m')), DATE(STR_TO_DATE(Master_Finiciomora,'%Y%m%d')))),
IF(SUM(Visa_Finiciomora) = 0, 0, DATEDIFF(DATE(STR_TO_DATE('201606','%Y%m')), DATE(STR_TO_DATE(Visa_Finiciomora,'%Y%m%d')))),

DATEDIFF(DATE(STR_TO_DATE('201606','%Y%m')), DATE(STR_TO_DATE(Master_Finiciomora,'%Y%m%d'))),
DATEDIFF(DATE(STR_TO_DATE('201606','%Y%m')), DATE(STR_TO_DATE(Visa_Finiciomora,'%Y%m%d')))
